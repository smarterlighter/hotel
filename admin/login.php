        ...
        <form id="form" class="form-horizontal" role="form" action="login.php" method="post">
            ...
            <div class="col-sm-6 col-md-4" id="loginWrapper">
                ...
                <div id="login">
                    ...
                    <?php
                    if($action == 'reset'){ ?>
                        <p>請輸入與您的帳戶對應的電子郵件地址. 新密碼將通過電子郵件發送給您.</p>
                        <div class="row">
                        ...
                        <div class="row mb10">
                            <div class="col-xs-3 text-left">
                                <a href="login.php"><i class="fas fa-fw fa-power-off"></i> 登入</a>
                            </div>
                            <div class="col-xs-9 text-right">
                                <button class="btn btn-default" type="submit" value="" name="reset"><i class="fas fa-fw fa-sync"></i> 獲取新密碼</button>
                            </div>
                        </div>
                        <?php
                    }else{
                        ...
                        <div class="row mb10">
                            <div class="col-sm-7 text-left">
                                <a href="login.php?action=reset">忘記密碼&nbsp;?</a>
                            </div>
